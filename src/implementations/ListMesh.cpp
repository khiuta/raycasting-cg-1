...
ListMesh::ListMesh(std::vector<std::unique_ptr<Triangle>> faces, std::vector<std::unique_ptr<Point4>> vertices, Point4 centroid) 
  : faces(std::move(faces)), vertices(std::move(vertices)), centroid(centroid) {};
